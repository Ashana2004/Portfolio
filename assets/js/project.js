...
const projects = [
  {
    title: "MentalHealth AICompanion ",
    cardImage: "assets/images/project-page/mentalhealth.jpg",
    ...
    // Previewlink: "https://job-sensai.vercel.app/",
    Githublink: "https://github.com/Ashana2004/",
  },
  {
    title: "LawSathi(in Progress)",
    cardImage: "assets/images/project-page/Lawsathi.jpg",
  ...
  },
  {
    ...
    cardImage: "assets/images/project-page/ainews.jpg",
    description: "VoiceLens is an AI-powered accessibility tool that converts images into spoken captions, enabling visually impaired users to understand visual content through simple gestures.",
    tagimg: "",
    // Previewlink: "",
    Githublink: "https://github.com/Ashana2004/AI-news-Aggregator",
  },
  
  {
    title: "Virtual campus tour",
    cardImage: "assets/images/project-page/vr.jpg",
  ...
  },
  {
    ...
    tagimg: "https://github.com/Ashana2004/",
    Previewlink: "",
    Githublink: "",
  },
...
function myFunction() {
  ...
  let skillcard = document.getElementsByClassName("skill-card");
  let card = document.getElementsByClassName("card");
  let title = document.getElementsByClassName("title");

  for (let i = 0; i < title.length; i++) {
    if (title[i].innerText.toUpperCase().includes(input)) {
